...
INSERT INTO `mst_user` (`id_user`, `nama`, `nik`, `bagian_id`, `email`, `password`, `level`, `date_created`, `image`, `is_active`) VALUES (15, 'Donny Kurniawan', '0111844', 1, 'admin@gmail.com', '$2y$10$VUEKgUN6JfiE.Ka7.yKXI.Arwpcvy2IP1JV.csFCQFMGYPfCbkayO', 'Admin', '2019-10-02', 'avatar5.png', 1);
INSERT INTO `mst_user` (`id_user`, `nama`, `nik`, `bagian_id`, `email`, `password`, `level`, `date_created`, `image`, `is_active`) VALUES (16, 'Donny Kurniawan', '12345678', 2, 'user@gmail.com', '$2y$10$0aRVOiYs3D2ZsMBbjpvsfuiCHG0NaO8YcIxTmcf5q.08Ta5owEVCm', 'User', '2019-10-02', 'avatar5.png', 1);
INSERT INTO `mst_user` (`id_user`, `nama`, `nik`, `bagian_id`, `email`, `password`, `level`, `date_created`, `image`, `is_active`) VALUES (22, 'Ratna Damayanti', '987654321', 3, 'maya_ratna@gmail.com', '$2y$10$0aRVOiYs3D2ZsMBbjpvsfuiCHG0NaO8YcIxTmcf5q.08Ta5owEVCm', 'User', '2020-06-20', 'default.png', 1);
...
INSERT INTO `tb_gaji` (`id_gaji`, `tgl_gaji`, `struktur_kode_gaji`, `gapok`, `bonus`, `bpjs`, `tunjangan`, `transportasi`, `kehadiran`) VALUES (17, '2021-07-25', '2020060003', 2500000, 0, 50000, 0, 0, 0);
...
INSERT INTO `tbl_aplikasi` (`id`, `nama_aplikasi`, `alamat`, `telp`, `nama_developer`, `logo`, `token_bot`, `id_grup`) VALUES (1, 'penggajian', 'sadas', '323', 'marsya', 'Strawberry_(3).png', '1921840682:AAFV3ovQckJgOvdnir2JcVgCkp_UruadwMw', '-511005767');
...
INSERT INTO `tbl_setting_gaji` (`id`, `kehadiran`, `keterlambatan`, `mulai_absen_masuk`, `mulai_absen_keluar`, `total_absen`) VALUES (1, 31000, 25000, '08:00:00', '18:00:00', 25);
