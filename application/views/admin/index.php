                ...
                <div class="col-lg-12">
                        <div class="widget-head-color-box navy-bg p-lg text-center">
                            ...
                            <h2 class="font-bold no-margins">
                                ...
                                Selamat Datang Di <?= $identitas->nama_aplikasi?>
                            </h2>
                                <strong><?php echo $user['nama']; ?></strong>
                            </div>

                            <img src="<?php echo base_url('assets/dist/aplikasi/') . $identitas->logo; ?>" alt="profile" class="brand-image img-circle elevation-3" style="height:100px">
                            <div>
